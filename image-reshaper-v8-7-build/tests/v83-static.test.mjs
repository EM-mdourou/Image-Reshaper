...
assert.match(html,/const APP_VERSION='8\.7'/);
assert.match(html,/Version 8\.7/);
...
console.log('PASS v8.7 static architecture tests');
...
console.log('PASS v8.7 manifest reuse/background diagnostics tests');
