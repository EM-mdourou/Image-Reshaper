...
const code=[extract('defaultTextStyleForRole'),extract('applyVisualInstructionToPlan'),extract('tinyLayoutGeometry'),extract('manifestFingerprint')].join('\n');
...
console.log('PASS v8.6 frontend state/color tests');
...
console.log('PASS v8.6 tiny geometry no-overlap tests');
...
console.log('PASS v8.6 manifest fingerprint test');
