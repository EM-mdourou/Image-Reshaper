...
console.log('PASS v8.10 frontend state/color tests');
...
console.log('PASS v8.10 tiny geometry no-overlap tests');
...
console.log('PASS v8.10 manifest fingerprint test');
