...
assert.match(html,/const APP_VERSION='8\.6'/);
assert.match(html,/Version 8\.6/);
...
console.log('PASS v8.6 static architecture tests');
...
console.log('PASS v8.6 manifest reuse/background diagnostics tests');
