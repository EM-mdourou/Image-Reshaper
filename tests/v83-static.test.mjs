...
assert.match(html,/const APP_VERSION='8\.5'/);
assert.match(html,/Version 8\.5/);
...
console.log('PASS v8.5 static architecture tests');
...
console.log('PASS v8.5 manifest reuse/background diagnostics tests');
