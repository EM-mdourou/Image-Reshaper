...
assert.match(html,/const APP_VERSION='8\.3'/);
assert.match(html,/Version 8\.3/);
...
console.log('PASS v8.3 static architecture tests');
...
console.log('PASS v8.3 manifest reuse/background diagnostics tests');
