...
console.log('PASS v8.2 routing/profile tests');
...
console.log('PASS v8.2 preset routing matrix');
...
console.log('PASS v8.2 fit-budget tests');
...
console.log('PASS v8.2 user-added text priority test');
