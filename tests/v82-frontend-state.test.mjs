...
const code=[extract('defaultTextStyleForRole'),extract('applyVisualInstructionToPlan'),extract('tinyLayoutGeometry')].join('\n');
...
console.log('PASS v8.2 frontend state/color tests');
...
console.log('PASS v8.2 tiny geometry no-overlap tests');
