...
console.log('PASS v8.9 routing/profile tests');
...
console.log('PASS v8.9 preset routing matrix');
...
console.log('PASS v8.9 fit-budget tests');
...
console.log('PASS v8.9 user-added text priority test');
