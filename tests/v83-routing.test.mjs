...
console.log('PASS v8.6 routing/profile tests');
...
console.log('PASS v8.6 preset routing matrix');
...
console.log('PASS v8.6 fit-budget tests');
...
console.log('PASS v8.6 user-added text priority test');
