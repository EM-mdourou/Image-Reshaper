...
console.log('PASS v8.10 routing/profile tests');
...
console.log('PASS v8.10 preset routing matrix');
...
console.log('PASS v8.10 fit-budget tests');
...
console.log('PASS v8.10 user-added text priority test');
