...
assert.match(html,/const APP_VERSION='8\.11'/);
...
console.log('PASS v8.11 static architecture tests');
...
console.log('PASS v8.11 manifest reuse/background diagnostics tests');
