...
console.log('PASS v8.11 frontend state/color tests');
...
console.log('PASS v8.11 tiny geometry no-overlap tests');
...
console.log('PASS v8.11 manifest fingerprint test');
