...
console.log('PASS v8.11 routing/profile tests');
...
console.log('PASS v8.11 preset routing matrix');
...
console.log('PASS v8.11 fit-budget tests');
...
console.log('PASS v8.11 user-added text priority test');
